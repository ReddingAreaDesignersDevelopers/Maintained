...
export const PropertyType = Enum.create({
	name: 'Property Type',
	identifiers: {
		WEB: 0,
		WEB_SITE: 1,
...
export const PropertyURL = GenericDashObject.inherit({
	name: 'Property URL',
	fields: {
		address: String
	}
...
export const PropertyStatus = Enum.create({
...
export const StyleColor = GenericDashObject.inherit({
	name: 'Style Color',
	fields: {
		value: {
...
export const StyleFont = GenericDashObject.inherit({
	name: 'Style Font',
	fields: {
		size: {
			type: String,
...
// such as helvetica
export const StyleTypeface = GenericDashObject.inherit({
	name: 'Style Typeface',
	fields: {
		name: String,
		fonts: {
...
export const PropertyStyle = Class.create({
	name: 'Property Style',
	fields: {
		colors: {
			type: [StyleColor],
